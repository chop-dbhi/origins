...
func benchSortConcatSort(b *testing.B, comp Comparator, n, m int) {
	b.StopTimer()
...
func BenchmarkSort_EAVT_ConcatSort__500_10(b *testing.B) {
	benchSortConcatSort(b, EAVTComparator, 500, 10)
}

func BenchmarkSort_AVET_ConcatSort__500_10(b *testing.B) {
	benchSortConcatSort(b, AVETComparator, 500, 10)
}

func BenchmarkSort_AEVT_ConcatSort__500_10(b *testing.B) {
	benchSortConcatSort(b, AEVTComparator, 500, 10)
}

func BenchmarkSort_VAET_ConcatSort__500_10(b *testing.B) {
	benchSortConcatSort(b, VAETComparator, 500, 10)
}
